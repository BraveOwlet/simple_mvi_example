...
internal sealed interface FlowTestScreenEffect : MviEffect{
    ...
    data class AddValue1(val value : Int, val timeEmit : Instant, val timeCollect : Instant) : FlowTestScreenEffect
    data class AddValue2(val value : Int, val timeEmit : Instant, val timeCollect : Instant) : FlowTestScreenEffect
